...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx072c60f75cb27434',

  // 使用微信测试号时才需要填写：公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '3cff0e38f60bd12201619a82118ce3df',
  ...
  USERS: [
    {
      ...
      useTemplateId: '0bXvbK9axHWEJcZj5bjBuZ7PwX2DXNIU6-cU4ctOP5g',
      // 所在省份或城市，也可以不填
      province: '阿克苏',
      // 所在城市或县区
      city: '温宿',
  ...
  CALLBACK_TEMPLATE_ID: '7qk9lEhvJ4ZGxv5eTIVEL72ZWpcc6f6yNHa8ItW0hSw',
